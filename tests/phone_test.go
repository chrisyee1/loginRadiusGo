...
func unverifyPhone(uid string) {
	...
	loginradius.PutManageAccountUpdate(uid, falsePhoneIDVerified)
}
...
func TestPostPhoneLogin(t *testing.T) {
	...
	_, err := loginradius.PostPhoneLogin("", "", "", phoneLogin)
	if err != nil {
...
func TestPostPhoneForgotPasswordByOTP(t *testing.T) {
	...
	_, err := loginradius.PostPhoneForgotPasswordByOTP("SMS TEMPLATE", phone)
	if err != nil {
...
func TestPostPhoneResendVerificationOTP(t *testing.T) {
	...
	phone := TestPhone{phoneID}
	_, err := loginradius.PostPhoneResendVerificationOTP("SMS TEMPLATE", phone)
	if err != nil {
...
func TestPostPhoneResendVerificationOTPByToken(t *testing.T) {
	...
	unverifyPhone(testuid)
	phone := TestPhone{phoneID}
	_, err := loginradius.PostPhoneResendVerificationOTPByToken("SMS TEMPLATE", accessToken, phone)
	if err != nil {
...
func TestPostPhoneUserRegistrationBySMS(t *testing.T) {
	...
	session, err := loginradius.PostPhoneUserRegistrationBySMS("", "", "", phoneAccount)
...
func TestGetPhoneNumberAvailability(t *testing.T) {
	...
	phoneID, _, _, _, teardownTestCase := setupAccount(t)
	defer teardownTestCase(t)
	_, err := loginradius.GetPhoneNumberAvailability(phoneID)
	if err != nil {
...
func TestPutPhoneNumberUpdate(t *testing.T) {
	...
	session, err := loginradius.PutPhoneNumberUpdate("", accessToken, phone)
	if err != nil && session.IsPosted != true {
...
func TestPutResetPhoneIDVerification(t *testing.T) {
	...
	defer teardownTestCase(t)
	_, err := loginradius.PutResetPhoneIDVerification(testuid)
	if err != nil {
...
func TestDeleteRemovePhoneIDByAccessToken(t *testing.T) {
	...
	_, _, _, _, accessToken, teardownTestCase := setupLogin(t)
	defer teardownTestCase(t)
	_, err := loginradius.DeleteRemovePhoneIDByAccessToken(accessToken)
	if err != nil {
