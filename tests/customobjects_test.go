...
func setupCustomObject(t *testing.T) (string, string, string, string, func(t *testing.T)) {
	...
	object, err := loginradius.PostCustomObjectCreateByUID(objName, testuid, customObj)
	if err != nil {
	...
	return accessToken, testuid, object.ID, objName, func(t *testing.T) {
		...
		_, err2 := loginradius.DeleteCustomObjectByObjectRecordIDAndUID(objName, testuid, object.ID)
		if err2 != nil {
...
func TestPostCustomObjectCreateByUID(t *testing.T) {
	...
	timestamp := time.Format("20060102150405")
	customObj := TestCustomObject{timestamp + "0", timestamp + "1"}
	session, err := loginradius.PostCustomObjectCreateByUID(objName, testuid, customObj)
	if err != nil || session.ID == "" {
		t.Errorf("Error creating custom object")
		fmt.Println(err)
	}
	_, err2 := loginradius.DeleteCustomObjectByObjectRecordIDAndUID(objName, testuid, session.ID)
	if err2 != nil {
		t.Errorf("Error deleting custom object")
		fmt.Println(err)
	}
...
func TestPostCustomObjectCreateByToken(t *testing.T) {
	...
	timestamp := time.Format("20060102150405")
	customObj := TestCustomObject{timestamp + "0", timestamp + "1"}
	session, err := loginradius.PostCustomObjectCreateByToken(objName, accessToken, customObj)
	if err != nil || session.ID == "" {
		t.Errorf("Error creating custom object")
		fmt.Println(err)
	}
	_, err2 := loginradius.DeleteCustomObjectByObjectRecordIDAndToken(objName, accessToken, session.ID)
	if err2 != nil {
		t.Errorf("Error deleting custom object")
		fmt.Println(err)
	}
...
func TestGetCustomObjectByObjectRecordIDAndUID(t *testing.T) {
	...
	defer teardownTestCase(t)
	session, err := loginradius.GetCustomObjectByObjectRecordIDAndUID(objName, testuid, objectID)
...
func TestGetCustomObjectByObjectRecordIDAndToken(t *testing.T) {
	...
	defer teardownTestCase(t)
	session, err := loginradius.GetCustomObjectByObjectRecordIDAndToken(objName, accessToken, objectID)
	if err != nil || session.ID != objectID {
		t.Errorf("Error getting custom object")
		fmt.Println(err)
	}
...
func TestGetCustomObjectByToken(t *testing.T) {
	...
	defer teardownTestCase(t)
	session, err := loginradius.GetCustomObjectByToken(objName, accessToken)
...
func TestGetCustomObjectByUID(t *testing.T) {
	...
	defer teardownTestCase(t)
	session, err := loginradius.GetCustomObjectByUID(objName, testuid)
	if err != nil || session.Count != 1 {
		t.Errorf("Error getting custom object")
		fmt.Println(err)
	}
...
func TestPutCustomObjectUpdateByUID(t *testing.T) {
	...
	_, err := loginradius.PutCustomObjectUpdateByUID(objName, "replace", testuid, objectID, customObj)
	if err != nil {
...
func TestPutCustomObjectUpdateByToken(t *testing.T) {
	...
	defer teardownTestCase(t)
	customObj := TestCustomObject{objName + "3", objName + "4"}
	_, err := loginradius.PutCustomObjectUpdateByToken(objName, "replace", accessToken, objectID, customObj)
	if err != nil {
		t.Errorf("Error updating custom object")
		fmt.Println(err)
	}
...
func TestDeleteCustomObjectByObjectRecordIDAndUID(t *testing.T) {
	...
	session, err := loginradius.DeleteCustomObjectByObjectRecordIDAndUID(objName, testuid, objectID)
...
func TestDeleteCustomObjectByObjectRecordIDAndToken(t *testing.T) {
	...
	session, err := loginradius.DeleteCustomObjectByObjectRecordIDAndToken(objName, accessToken, objectID)
	if err != nil || session.IsDeleted == false {
		t.Errorf("Error updating custom object")
		fmt.Println(err)
	}
