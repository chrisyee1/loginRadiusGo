...
func setupRole(t *testing.T) (string, func(t *testing.T)) {
	...
	_, err := loginradius.PostRolesCreate(testRole)
	if err != nil {
	...
	return roleName, func(t *testing.T) {
		...
		_, err2 := loginradius.DeleteAccountRole(roleName)
		if err2 != nil {
...
func TestPostRolesCreateInvalid(t *testing.T) {
	...
	_, err := loginradius.PostRolesCreate(invalid)
	if err == nil {
...
func TestGetContextRolesPermissions(t *testing.T) {
	...
	_, err := loginradius.GetContextRolesPermissions(testuid)
	if err != nil {
...
func TestGetRolesList(t *testing.T) {
	...
	defer teardownTestCase(t)
	_, err := loginradius.GetRolesList()
	if err != nil {
...
func TestGetRolesByUID(t *testing.T) {
	...
	_, _, testuid, _, teardownTestCase := setupAccount(t)
	defer teardownTestCase(t)
	_, err := loginradius.GetRolesByUID(testuid)
	if err != nil {
...
func TestPutAccountAddPermissionsToRole(t *testing.T) {
	...
	_, err := loginradius.PutAccountAddPermissionsToRole(roleName, permissions)
	if err != nil {
		t.Errorf("Error getting roles for user")
		fmt.Println(err)
	}
...
func TestPutAccountAddPermissionsToRoleInvalid(t *testing.T) {
	...
	defer teardownTestCase(t)
	invalid := InvalidBody{"invalid"}
	_, err := loginradius.PutAccountAddPermissionsToRole(roleName, invalid)
	if err == nil {
		t.Errorf("Should be error")
		fmt.Println(err)
	}
...
func TestPutRolesAssignToUser(t *testing.T) {
	...
	_, err := loginradius.PutRolesAssignToUser(testuid, roles)
	if err != nil {
...
func TestPutRolesAssignToUserInvalid(t *testing.T) {
	...
	defer teardownAccount(t)
	invalid := InvalidBody{"invalid"}
	_, err := loginradius.PutRolesAssignToUser(testuid, invalid)
	if err == nil {
		t.Errorf("Should be error")
		fmt.Println(err)
	}
...
func TestPutRolesUpsertContext(t *testing.T) {
	...
	_, err := loginradius.PutRolesUpsertContext(testuid, roleContextContainer)
	if err != nil {
...
func TestPutRolesUpsertContextInvalid(t *testing.T) {
	...
	defer teardownAccount(t)
	invalid := InvalidBody{"invalid"}
	_, err := loginradius.PutRolesUpsertContext(testuid, invalid)
	if err == nil {
		t.Errorf("Should be error")
	}
	fmt.Println("Test complete")
...
func TestDeleteAccountRole(t *testing.T) {
	...
	_, err := loginradius.DeleteAccountRole(roleName)
	if err != nil {
		t.Errorf("Error deleting role")
		fmt.Println(err)
	}
...
func TestDeleteRolesAssignedToUser(t *testing.T) {
	...
	_, err2 := loginradius.DeleteRolesAssignedToUser(testuid, roles)
	if err2 != nil {
...
func TestDeleteRolesAccountRemovePermissions(t *testing.T) {
	...
	_, err2 := loginradius.DeleteRolesAccountRemovePermissions(roleName, permissions)
	if err2 != nil {
...
func TestDeleteContextFromRole(t *testing.T) {
	...
	_, err2 := loginradius.DeleteContextFromRole(testuid, "contextTest")
	if err2 != nil {
...
func TestDeleteRoleFromContext(t *testing.T) {
	...
	_, err2 := loginradius.DeleteRoleFromContext(testuid, "contextTest", roles)
	if err2 != nil {
		t.Errorf("Error deleting role context")
		fmt.Println(err2)
	}
...
func TestDeleteAdditionalPermissionFromContext(t *testing.T) {
	...
	_, err2 := loginradius.DeleteAdditionalPermissionFromContext(testuid, "contextTest", permissions)
	if err2 != nil {
		t.Errorf("Error deleting role context")
		fmt.Println(err2)
	}
